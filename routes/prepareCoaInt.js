...
router.post("/", isLoggedIn, async (req, res) => {
  ...
  try {
    ...
    if (templateCode === "R") {
      return res.redirect("/coa/redirectInt/relianceCoa");
    } else if (templateCode === "C"){
      return res.redirect("/coa/redirectInt/cokeCoa")
    }else if (templateCode === "L"){
      return res.redirect("/coa/redirectInt/others")
    }else if (templateCode === "B"){
      return res.redirect("/coa/redirectInt/bisleriWater")
    }
